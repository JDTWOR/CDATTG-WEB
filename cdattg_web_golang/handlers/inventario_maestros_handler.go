...
func NewProveedorHandler() *ProveedorHandler {
	return &ProveedorHandler{svc: services.NewProveedorService()}
}
...
// CategoriaHandler CRUD categorías
type CategoriaHandler struct {
	svc services.CategoriaService
}

func NewCategoriaHandler() *CategoriaHandler {
	return &CategoriaHandler{svc: services.NewCategoriaService()}
}
...
// MarcaHandler CRUD marcas
type MarcaHandler struct {
	svc services.MarcaService
}

func NewMarcaHandler() *MarcaHandler {
	return &MarcaHandler{svc: services.NewMarcaService()}
}

func (h *MarcaHandler) List(c *gin.Context) {
	list, err := h.svc.List()
	if err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"error": err.Error()})
		return
...
// ContratoConvenioHandler CRUD contratos/convenios
type ContratoConvenioHandler struct {
	svc services.ContratoConvenioService
}

func NewContratoConvenioHandler() *ContratoConvenioHandler {
	return &ContratoConvenioHandler{svc: services.NewContratoConvenioService()}
}
...
func (h *ContratoConvenioHandler) Delete(c *gin.Context) {
	...
	c.JSON(http.StatusOK, gin.H{"message": "Contrato/convenio eliminado"})
}
